            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card border-0 shadow rounded">
                        <div class="card-body">
                            <a href="{{ route('blog.create') }}" class="btn btn-md btn-success mb-3">
                            TAMBAH BLOG</a>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th score="col">GAMBAR</th>
                                        <th score="col">JUDUL</th>
                                        <th score="col">CONTENT</th>
                                        <th score="col">AKSI</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @empty
                                    <div class="alert alert-danger">Data Blog Belum Tersedia.</div>
                                    @endforelse
                                </tbody>
                            </table>
                            {{ $blogs->links()}}
