...
<body>
    ...
    <header class="fadeIn">
        <img src="https://i.ibb.co/LRvwhB9/backrond.jpg" alt="Profil Saya">
        <h1>Neng Rini Siti Patimah</h1>
        <p>Web Developer</p>
    </header>
    ...
    <section id="proyek-saya" class="fadeIn">
        ...
        <div class="project">
            ...
            <p>My Blogs </p>
            <img src="https://i.ibb.co/TwBmfq8/uts-ss.png" alt="uts-ss" border="0"></a>
        </div>

        <div class="project">
            <h3>Proyek Kedua</h3>
            <p>Deskripsi singkat tentang proyek kedua. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <img src="https://i.ibb.co/802R0sK/Screenshot-41.png" alt="Screenshot-41" border="0"></a>
    ...
    <section id="blog">
        ...
        <section id="kontak" class="fadeIn">
            <h2>Kontak</h2>
            <p>Hubungi saya melalui email: <a href="mailto:nengrinisitipatimah25@gmail.com">youremail@example.com</a></p>
            <div class="social">
                <a href="https://www.linkedin.com/in/username" target="_blank">LinkedIn</a>
                <a href="https://github.com/inii25" target="_blank">GitHub</a>
